...
/* harmony export */   "precedence": () => (/* reexport safe */ _codemirror_next_state__WEBPACK_IMPORTED_MODULE_8__.precedence),
...
/* harmony export */   "precedence": () => (/* reexport safe */ _config_js__WEBPACK_IMPORTED_MODULE_2__.precedence),
...
/* harmony import */ var _underlay_taslx_lezer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @underlay/taslx-lezer */ "./node_modules/@underlay/taslx-lezer/lib/index.js");
...
function lintView(view) {
  var cursor = (0,_codemirror_next_language__WEBPACK_IMPORTED_MODULE_1__.syntaxTree)(view.state).cursor();
  ...
  var error = function error(node, message) {
    return new _underlay_taslx_lezer__WEBPACK_IMPORTED_MODULE_3__.LintError(node.from, node.to, slice(node), message);
  };
  ...
  do {
    if (cursor.type.isError) {} else if (cursor.type.name === "Namespace") {
      ...
      if (term !== null) {
        ...
        if (!_underlay_taslx_lezer__WEBPACK_IMPORTED_MODULE_3__.uriPattern.test(namespace)) {
          var from = term.from,
              to = term.to;
          var message = "Invalid URI: URIs must match ".concat(_underlay_taslx_lezer__WEBPACK_IMPORTED_MODULE_3__.uriPattern.source);
        ...
        } else if (!_underlay_taslx_lezer__WEBPACK_IMPORTED_MODULE_3__.namespacePattern.test(namespace)) {
          var _from = term.from,
              _to = term.to;
      ...
      if (terms.length > 0) {
        ...
        if (key !== null) {
          if (key in state.mapping) {
            ...
            state.mapping[key] = _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Mapping.map(source, parseExprs(state, _expressions));
          }
        }
      }
    }
  ...
  return {
    ...
    namespaces: _objectSpread(_objectSpread({}, _underlay_taslx_lezer__WEBPACK_IMPORTED_MODULE_3__.defaultNamespaces), Object.fromEntries(namespaces)),
    diagnostics: sorted
  };
}
...
function getURI(state, node) {
  try {
    return (0,_underlay_taslx_lezer__WEBPACK_IMPORTED_MODULE_3__.parseURI)(state, node);
  } catch (e) {
    if (e instanceof _underlay_taslx_lezer__WEBPACK_IMPORTED_MODULE_3__.LintError) {
      var from = e.from,
          to = e.to,
          message = e.message,
          value = e.value;
...
function parseExpr(state, node) {
  if (node.name === "Variable") {
    ...
    return [_underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Mapping.dereference(key)];
    ...
    return [_underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Mapping.projection(_key)];
    ...
    return [_underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Mapping.injection(_key2)];
    ...
    return [_underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Mapping.identifier(_key3)];
    ...
    return [_underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Mapping.constant(_value, _key4)];
    ...
    return [_underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Mapping.tuple(slots)];
    ...
    return [_underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Mapping.match(cases)];
  } else {
...
/* harmony import */ var _underlay_taslx_lezer_grammar_taslx_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @underlay/taslx-lezer/grammar/taslx.js */ "./node_modules/@underlay/taslx-lezer/grammar/taslx.js");
...
/***/ "./node_modules/@underlay/taslx-lezer/grammar/taslx.js":
/*!*************************************************************!*\
  !*** ./node_modules/@underlay/taslx-lezer/grammar/taslx.js ***!
  \*************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
const parser = lezer__WEBPACK_IMPORTED_MODULE_0__.Parser.deserialize({
  ...
  maxTerm: 49,
  nodeProps: [
    [lezer__WEBPACK_IMPORTED_MODULE_0__.NodeProp.group, -8,10,11,13,15,17,18,20,22,"Expression"]
  ],
  skippedNodes: [0,1],
  repeatNodeCount: 4,
...
/***/ "./node_modules/@underlay/taslx-lezer/lib/index.js":
/*!*********************************************************!*\
  !*** ./node_modules/@underlay/taslx-lezer/lib/index.js ***!
  \*********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _parse_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parse.js */ "./node_modules/@underlay/taslx-lezer/lib/parse.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils.js */ "./node_modules/@underlay/taslx-lezer/lib/utils.js");
/* harmony import */ var _stdlib_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./stdlib.js */ "./node_modules/@underlay/taslx-lezer/lib/stdlib.js");
...
/***/ "./node_modules/@underlay/taslx-lezer/lib/parse.js":
/*!*********************************************************!*\
  !*** ./node_modules/@underlay/taslx-lezer/lib/parse.js ***!
  \*********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _grammar_taslx_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../grammar/taslx.js */ "./node_modules/@underlay/taslx-lezer/grammar/taslx.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils.js */ "./node_modules/@underlay/taslx-lezer/lib/utils.js");



function parse(input) {
    const slice = (node) => input.slice(node.from, node.to);
    const error = (node, message) => new _utils_js__WEBPACK_IMPORTED_MODULE_2__.LintError(node.from, node.to, slice(node), message);
    const state = {
        slice,
        error,
        namespaces: {},
    ...
    const tree = _grammar_taslx_js__WEBPACK_IMPORTED_MODULE_1__.parser.configure({ strict: true }).parse(input);
    ...
    do {
        if (cursor.type.name === "Namespace") {
            ...
            if (!_utils_js__WEBPACK_IMPORTED_MODULE_2__.uriPattern.test(namespace)) {
                throw state.error(term, `Invalid URI: URIs must match ${_utils_js__WEBPACK_IMPORTED_MODULE_2__.uriPattern.source}`);
            }
            ...
            const terms = termNodes.map((node) => (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.parseURI)(state, node));
            const key = terms[0];
...
const parseExprs = (state, nodes) => nodes.reduce((exprs, node) => exprs.concat(parseExpr(state, node)), []);
function parseExpr(state, node) {
    if (node.name === "Variable") {
        ...
        const key = (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.parseURI)(state, term);
        return [_underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Mapping.dereference(key)];
    }
    else if (node.name === "Projection") {
        const term = node.getChild("Term");
        const key = (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.parseURI)(state, term);
        return [_underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Mapping.projection(key)];
    }
    else if (node.name === "Injection") {
        const term = node.getChild("Term");
        const key = (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.parseURI)(state, term);
        return [_underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Mapping.injection(key)];
    }
    else if (node.name === "Identifier") {
        const term = node.getChild("Term");
        const key = (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.parseURI)(state, term);
        return [_underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Mapping.identifier(key)];
    }
    else if (node.name === "Constant") {
        ...
        const term = node.getChild("Term");
        const datatype = (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.parseURI)(state, term);
        return [_underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Mapping.constant(value, datatype)];
    }
    else if (node.name === "Tuple") {
        const slots = {};
...
/***/ "./node_modules/@underlay/taslx-lezer/lib/stdlib.js":
/*!**********************************************************!*\
  !*** ./node_modules/@underlay/taslx-lezer/lib/stdlib.js ***!
  \**********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@underlay/taslx-lezer/lib/utils.js":
/*!*********************************************************!*\
  !*** ./node_modules/@underlay/taslx-lezer/lib/utils.js ***!
  \*********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
