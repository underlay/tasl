...
/* harmony import */ var _codemirror_next_highlight_selection__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @codemirror/next/highlight-selection */ "./node_modules/@codemirror/next/highlight-selection/dist/index.js");
...
var readOnlyConfig = [_codemirror_next_view__WEBPACK_IMPORTED_MODULE_2__.EditorView.editable.of(false), (0,_codemirror_next_gutter__WEBPACK_IMPORTED_MODULE_4__.lineNumbers)(), _codemirror_next_highlight__WEBPACK_IMPORTED_MODULE_6__.defaultHighlightStyle, (0,_codemirror_next_highlight_selection__WEBPACK_IMPORTED_MODULE_5__.highlightSelectionMatches)(), _syntax_js__WEBPACK_IMPORTED_MODULE_7__.syntax];
var editableConfig = [_codemirror_next_basic_setup__WEBPACK_IMPORTED_MODULE_0__.basicSetup, _syntax_js__WEBPACK_IMPORTED_MODULE_7__.syntax, (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_2__.keymap)([].concat(_toConsumableArray(_codemirror_next_commands__WEBPACK_IMPORTED_MODULE_1__.defaultKeymap), _toConsumableArray(_codemirror_next_comment__WEBPACK_IMPORTED_MODULE_3__.commentKeymap), [{
  key: "Tab",
  preventDefault: true,
...
/* harmony export */   "makeLinter": () => (/* reexport safe */ _lint_js__WEBPACK_IMPORTED_MODULE_1__.makeLinter),
...
/* harmony export */   "makeLinter": () => (/* binding */ makeLinter)
/* harmony export */ });
...
/* harmony import */ var _underlay_apg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @underlay/apg */ "./node_modules/@underlay/apg/lib/index.js");
/* harmony import */ var _underlay_namespaces__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @underlay/namespaces */ "./node_modules/@underlay/namespaces/lib/index.js");
/* harmony import */ var _underlay_tasl_lezer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @underlay/tasl-lezer */ "./node_modules/@underlay/tasl-lezer/lib/index.js");
...
function lintView(_ref) {
  ...
  var cursor = (0,_codemirror_next_language__WEBPACK_IMPORTED_MODULE_1__.syntaxTree)(state).cursor();
  ...
  var error = function error(node, message) {
    return new _underlay_tasl_lezer__WEBPACK_IMPORTED_MODULE_4__.LintError(node.from, node.to, slice(node), message);
  };
  ...
  var parseState = {
    ...
    namespaces: {},
    references: [],
    types: _objectSpread({}, _underlay_tasl_lezer__WEBPACK_IMPORTED_MODULE_4__.defaultTypes),
    schema: {}
  };
  var diagnostics = [];
  ...
  do {
    if (cursor.type.isError) {} else if (cursor.type.name === "Namespace") {
      ...
      if (term !== null) {
        ...
        if (!_underlay_tasl_lezer__WEBPACK_IMPORTED_MODULE_4__.uriPattern.test(namespace)) {
          var from = term.from,
              to = term.to;
          var message = "Invalid URI: URIs must match ".concat(_underlay_tasl_lezer__WEBPACK_IMPORTED_MODULE_4__.uriPattern.source);
          diagnostics.push({
            from: from,
            to: to,
            message: message,
        ...
        } else if (!_underlay_tasl_lezer__WEBPACK_IMPORTED_MODULE_4__.namespacePattern.test(namespace)) {
          var _from = term.from,
              _to = term.to;
      ...
      var type = expression === null ? _error_js__WEBPACK_IMPORTED_MODULE_5__.errorUnit : getType(parseState, diagnostics, expression);
      ...
      if (_term !== null) {
        ...
        if (uri !== null) {
          if (uri in parseState.schema) {
            ...
            parseState.schema[uri] = _expression === null ? _error_js__WEBPACK_IMPORTED_MODULE_5__.errorUnit : getType(parseState, diagnostics, _expression);
          }
        }
      }
      ...
      if (terms.length === 3 && uris.length === 3) {
        ...
        var components = (_components = {}, _defineProperty(_components, _underlay_namespaces__WEBPACK_IMPORTED_MODULE_3__.ul.source, _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.reference(source)), _defineProperty(_components, _underlay_namespaces__WEBPACK_IMPORTED_MODULE_3__.ul.target, _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.reference(target)), _components);

        var _expression2 = cursor.node.getChild("Expression");

        if (_expression2 !== null) {
          components[_underlay_namespaces__WEBPACK_IMPORTED_MODULE_3__.ul.value] = getType(parseState, diagnostics, _expression2);
        }

        parseState.schema[label] = _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.product(components);
      }
      ...
      var head = _expression3 === null ? _error_js__WEBPACK_IMPORTED_MODULE_5__.errorUnit : getType(parseState, diagnostics, _expression3);
      ...
      if (_term2 !== null) {
        ...
        parseState.schema[_uri] = _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.coproduct((_Schema$coproduct2 = {}, _defineProperty(_Schema$coproduct2, _underlay_namespaces__WEBPACK_IMPORTED_MODULE_3__.ul.none, _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.product({})), _defineProperty(_Schema$coproduct2, _underlay_namespaces__WEBPACK_IMPORTED_MODULE_3__.ul.some, _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.coproduct((_Schema$coproduct = {}, _defineProperty(_Schema$coproduct, _underlay_namespaces__WEBPACK_IMPORTED_MODULE_3__.ul.head, head), _defineProperty(_Schema$coproduct, _underlay_namespaces__WEBPACK_IMPORTED_MODULE_3__.ul.tail, _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.reference(_uri)), _Schema$coproduct))), _Schema$coproduct2));
      }
    }
  ...
  return {
    ...
    namespaces: _objectSpread(_objectSpread({}, _underlay_tasl_lezer__WEBPACK_IMPORTED_MODULE_4__.defaultNamespaces), Object.fromEntries(namespaces)),
    diagnostics: sorted
  };
}
var makeLinter = function makeLinter(onChange) {
  return (0,_codemirror_next_lint__WEBPACK_IMPORTED_MODULE_0__.linter)(function (view) {
    var _lintView = lintView(view),
...
function getURI(state, diagnostics, node) {
  try {
    return (0,_underlay_tasl_lezer__WEBPACK_IMPORTED_MODULE_4__.parseURI)(state, node);
  } catch (e) {
    if (e instanceof _underlay_tasl_lezer__WEBPACK_IMPORTED_MODULE_4__.LintError) {
      var from = e.from,
          to = e.to,
          message = e.message,
          value = e.value;
...
function getType(state, diagnostics, node) {
  if (node.name === "Variable") {
    ...
    if (value in state.types) {
      ...
      return _error_js__WEBPACK_IMPORTED_MODULE_5__.errorUnit;
    }
  } else if (node.name === "Optional") {
    var _Schema$coproduct3;

    var expression = node.getChild("Expression");
    var type = expression === null ? _error_js__WEBPACK_IMPORTED_MODULE_5__.errorUnit : getType(state, diagnostics, expression);
    return _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.coproduct((_Schema$coproduct3 = {}, _defineProperty(_Schema$coproduct3, _underlay_namespaces__WEBPACK_IMPORTED_MODULE_3__.ul.none, _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.product({})), _defineProperty(_Schema$coproduct3, _underlay_namespaces__WEBPACK_IMPORTED_MODULE_3__.ul.some, type), _Schema$coproduct3));
    ...
    return _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.reference(key);
  } else if (node.name === "Uri") {
    return _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.uri();
    ...
    return _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.literal(datatype);
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        components[_key] = _expression4 === null ? _error_js__WEBPACK_IMPORTED_MODULE_5__.errorUnit : getType(state, diagnostics, _expression4);
      }
    } catch (err) {
      _iterator2.e(err);
    } finally {
    ...
    return _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.product(components);
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        ...
        options[_key2] = _expression5 === null ? _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.product({}) : getType(state, diagnostics, _expression5);
      }
    } catch (err) {
      _iterator3.e(err);
    } finally {
    ...
    return _underlay_apg__WEBPACK_IMPORTED_MODULE_2__.Schema.coproduct(options);
  } else {
...
/* harmony import */ var _underlay_tasl_lezer_grammar_tasl_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @underlay/tasl-lezer/grammar/tasl.js */ "./node_modules/@underlay/tasl-lezer/grammar/tasl.js");
...
/* harmony export */   "completeSnippets": () => (/* binding */ completeSnippets),
...
class CompletionContext {
    ...
    tokenBefore(types) {
        let token = (0,_codemirror_next_language__WEBPACK_IMPORTED_MODULE_2__.syntaxTree)(this.state).resolve(this.pos, -1);
...
const baseTheme = _codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.EditorView.baseTheme({
...
function createListBox(options, id, range) {
    ...
    for (let i = range.from; i < range.to; i++) {
        ...
        icon.className = (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.themeClass)("completionIcon" + (completion.type ? "." + completion.type : ""));
        icon.setAttribute("aria-hidden", "true");
        let labelElt = li.appendChild(document.createElement("span"));
        labelElt.className = (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.themeClass)("completionLabel");
        ...
        for (let j = 1; j < match.length;) {
            ...
            span.className = (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.themeClass)("completionMatchedText");
            off = to;
        }
        if (off < label.length)
        ...
        if (detail) {
            ...
            detailElt.className = (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.themeClass)("completionDetail");
            detailElt.textContent = detail;
        }
        li.setAttribute("role", "option");
    }
    if (range.from)
        ul.classList.add((0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.themeClass)("completionListIncompleteTop"));
    if (range.to < options.length)
        ul.classList.add((0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.themeClass)("completionListIncompleteBottom"));
    return ul;
}
function createInfoDialog(option) {
    let dom = document.createElement("div");
    dom.className = (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.themeClass)("tooltip.completionInfo");
...
class CompletionTooltip {
    ...
    measureInfo() {
        ...
        if (top < 0 || top > this.list.clientHeight - 10)
            return null;
        let left = this.view.textDirection == _codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.Direction.RTL;
...
const completionState = _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.StateField.define({
    ...
    provide: [
        _codemirror_next_tooltip__WEBPACK_IMPORTED_MODULE_0__.showTooltip.nFrom(state => state.tooltip),
        _codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.EditorView.contentAttributes.from(state => state.attrs)
    ]
});
...
const completionPlugin = _codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.ViewPlugin.fromClass(class {
    constructor(view) {
        this.view = view;
            ...
            if (doesReset ||
                ...
                for (let handler of query.context.abortListeners) {
                    try {
                        ...
                        (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.logException)(this.view.state, e);
                    }
                }
    ...
    startQuery(active) {
        ...
        Promise.resolve(active.source(context)).then(result => {
            ...
            (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.logException)(this.view.state, err);
        });
    }
    scheduleAccept() {
        ...
        for (let line of this.lines) {
            if (text.length) {
                ...
                for (let i = 0; i < tabs; i++)
                    indent += state.facet(_codemirror_next_language__WEBPACK_IMPORTED_MODULE_2__.indentUnit);
...
let fieldMarker = _codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.Decoration.widget({ widget: new class extends _codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.WidgetType {
        toDOM() {
            let span = document.createElement("span");
            span.className = (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.themeClass)("snippetFieldPosition");
            return span;
        }
        ignoreEvent() { return false; }
    } });
let fieldRange = _codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.Decoration.mark({ class: (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.themeClass)("snippetField") });
class ActiveSnippet {
    constructor(ranges, active) {
        this.ranges = ranges;
        this.active = active;
        this.deco = _codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.Decoration.set(ranges.map(r => (r.from == r.to ? fieldMarker : fieldRange).range(r.from, r.to)));
    }
    map(changes) {
...
const snippetState = _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.StateField.define({
    ...
    provide: [_codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.EditorView.decorations.from(val => val ? val.deco : _codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.Decoration.none)]
});
...
const snippetKeymap = (0,_codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.precedence)((0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.keymap)([
...
function autocompletion(config = {}) {
    return [
        ...
        (0,_codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.precedence)((0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_3__.keymap)([
...
function ifNotIn(nodes, source) {
    return (context) => {
        for (let pos = (0,_codemirror_next_language__WEBPACK_IMPORTED_MODULE_2__.syntaxTree)(context.state).resolve(context.pos, -1); pos; pos = pos.parent)
...
/* harmony import */ var _codemirror_next_goto_line__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @codemirror/next/goto-line */ "./node_modules/@codemirror/next/goto-line/dist/index.js");
/* harmony import */ var _codemirror_next_highlight_selection__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @codemirror/next/highlight-selection */ "./node_modules/@codemirror/next/highlight-selection/dist/index.js");
/* harmony import */ var _codemirror_next_highlight__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @codemirror/next/highlight */ "./node_modules/@codemirror/next/highlight/dist/index.js");
/* harmony import */ var _codemirror_next_lint__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @codemirror/next/lint */ "./node_modules/@codemirror/next/lint/dist/index.js");
...
const basicSetup = [
    ...
    _codemirror_next_highlight__WEBPACK_IMPORTED_MODULE_15__.defaultHighlightStyle,
    ...
    (0,_codemirror_next_highlight_selection__WEBPACK_IMPORTED_MODULE_14__.highlightActiveLine)(),
    (0,_codemirror_next_highlight_selection__WEBPACK_IMPORTED_MODULE_14__.highlightSelectionMatches)(),
    (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_0__.keymap)([
        ...
        ..._codemirror_next_goto_line__WEBPACK_IMPORTED_MODULE_13__.gotoLineKeymap,
        ..._codemirror_next_autocomplete__WEBPACK_IMPORTED_MODULE_10__.completionKeymap,
        ..._codemirror_next_lint__WEBPACK_IMPORTED_MODULE_16__.lintKeymap
    ])
];
...
function handleClose(state, _open, close) {
    ...
    return dont ? null : state.update({
        selection: _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.EditorSelection.create(moved, state.selection.primaryIndex),
        scrollIntoView: true,
    ...
    return [
        (0,_codemirror_next_gutter__WEBPACK_IMPORTED_MODULE_3__.gutter)({
            ...
            lineMarker(view, line) {
                ...
                if (folded)
                    return canUnfold;
                if ((0,_codemirror_next_language__WEBPACK_IMPORTED_MODULE_2__.foldable)(view.state, line.from, line.to))
                    return canFold;
                return null;
            },
            initialSpacer() {
...
/* harmony export */   "gotoLineKeymap": () => (/* binding */ gotoLineKeymap)
/* harmony export */ });
/* harmony import */ var _codemirror_next_panel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @codemirror/next/panel */ "./node_modules/@codemirror/next/panel/dist/index.js");
/* harmony import */ var _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @codemirror/next/state */ "./node_modules/@codemirror/next/state/dist/index.js");
/* harmony import */ var _codemirror_next_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @codemirror/next/view */ "./node_modules/@codemirror/next/view/dist/index.js");
...
function createLineDialog(view) {
    ...
    dom.innerHTML = `<label>${view.state.phrase("Go to line:")} <input class=${(0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_2__.themeClass)("textfield")} name=line></label>
<button class=${(0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_2__.themeClass)("button")} type=submit>${view.state.phrase("go")}</button>`;
    let input = dom.querySelector("input");
    function go() {
        let n = parseInt(input.value, 10);
        view.dispatch({
            reconfigure: { [extTag]: [baseTheme] },
            selection: !isNaN(n) && n > 0 && n <= view.state.doc.lines ? _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.EditorSelection.cursor(view.state.doc.line(n).from) : undefined,
            scrollIntoView: true
        });
        view.focus();
    }
...
/// selector.
const gotoLine = view => {
    let panel = (0,_codemirror_next_panel__WEBPACK_IMPORTED_MODULE_0__.getPanel)(view, createLineDialog);
    if (!panel) {
        view.dispatch({ reconfigure: { append: [(0,_codemirror_next_panel__WEBPACK_IMPORTED_MODULE_0__.panels)(), _codemirror_next_panel__WEBPACK_IMPORTED_MODULE_0__.showPanel.of(createLineDialog), baseTheme] } });
        panel = (0,_codemirror_next_panel__WEBPACK_IMPORTED_MODULE_0__.getPanel)(view, createLineDialog);
    }
    if (panel)
...
const lineDeco = _codemirror_next_view__WEBPACK_IMPORTED_MODULE_0__.Decoration.line({ attributes: { class: (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_0__.themeClass)("activeLine") } });
...
/* harmony export */   "treeHighlighter": () => (/* binding */ treeHighlighter)
/* harmony export */ });
...
function treeHighlighter(language) {
    return (0,_codemirror_next_state__WEBPACK_IMPORTED_MODULE_3__.precedence)(_codemirror_next_view__WEBPACK_IMPORTED_MODULE_2__.ViewPlugin.define(view => new TreeHighlighter(view, language), {
        decorations: v => v.decorations
    }), "fallback");
}
class TreeHighlighter {
    ...
    buildDeco(view) {
        ...
        let flush = (pos, style) => {
            if (pos > start && style) {
                let mark = this.markCache[style] || (this.markCache[style] = _codemirror_next_view__WEBPACK_IMPORTED_MODULE_2__.Decoration.mark({ class: style }));
...
const defaultHighlightStyle = (0,_codemirror_next_state__WEBPACK_IMPORTED_MODULE_3__.precedence)(highlightStyle({ tag: tags.deleted,
...
const language = _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.Facet.define();
...
function defineLanguageFacet(baseData) {
    return _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.Facet.define({
...
class Language {
    ...
    data, parser, extraExtensions = []) {
        ...
        if (!_codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.EditorState.prototype.hasOwnProperty("tree"))
            Object.defineProperty(_codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.EditorState.prototype, "tree", { get() { return syntaxTree(this); } });
        let setState = _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.StateEffect.define();
        this.parser = parser;
        this.field = _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.StateField.define({
            create(state) {
                let parseState = new EditorParseContext(parser, state, [], lezer_tree__WEBPACK_IMPORTED_MODULE_0__.Tree.empty, { from: 0, to: state.doc.length }, []);
        ...
        this.extension = [
            language.of(this),
            this.field,
            _codemirror_next_view__WEBPACK_IMPORTED_MODULE_2__.ViewPlugin.define(view => new ParseWorker(view, this.field, setState)),
            (0,_codemirror_next_highlight__WEBPACK_IMPORTED_MODULE_3__.treeHighlighter)(this),
            _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.EditorState.languageData.of((state, pos) => state.facet(this.languageDataFacetAt(state, pos)))
...
function syntaxTree(state) {
    ...
    return lang.length ? lang[0].getTree(state) : lezer_tree__WEBPACK_IMPORTED_MODULE_0__.Tree.empty;
}
...
class EditorParseContext {
    ...
    work(time, upto) {
        ...
        for (;;) {
            ...
            if (done) {
                this.fragments = lezer_tree__WEBPACK_IMPORTED_MODULE_0__.TreeFragment.addTree(done);
                this.parse = null;
                this.tree = done;
                return true;
            }
    ...
    takeTree() {
        if (this.parse && this.parse.pos > this.tree.length) {
            ...
            this.fragments = lezer_tree__WEBPACK_IMPORTED_MODULE_0__.TreeFragment.addTree(this.tree, this.fragments, true);
        }
    }
    /// @internal
    ...
    cutFragments(from, to) {
        this.fragments = lezer_tree__WEBPACK_IMPORTED_MODULE_0__.TreeFragment.applyChanges(this.fragments, [{ fromA: from, toA: to, fromB: from, toB: to }]);
    }
    /// @internal
    reset() {
        if (this.parse) {
...
const indentService = _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.Facet.define();
/// Facet for overriding the unit by which indentation happens.
/// Should be a string consisting either entirely of spaces or
/// entirely of tabs. When not set, this defaults to 2 spaces.
const indentUnit = _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.Facet.define({
    combine: values => {
        if (!values.length)
            return "  ";
        if (!/^(?: +|\t+)$/.test(values[0]))
...
function getIndentation(context, pos) {
    if (context instanceof _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.EditorState)
...
class IndentContext {
    ...
    countColumn(line, pos) {
        return (0,_codemirror_next_text__WEBPACK_IMPORTED_MODULE_4__.countColumn)(pos < 0 ? line : line.slice(0, pos), 0, this.state.tabSize);
    }
...
function indentOnInput() {
    return _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.EditorState.transactionFilter.of(tr => {
        if (!tr.docChanged || tr.annotation(_codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.Transaction.userEvent) != "input")
            return tr;
...
const foldService = _codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.Facet.define();
...
function renderDiagnostic(view, diagnostic) {
    ...
    dom.className = (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_0__.themeClass)("diagnostic." + diagnostic.severity);
    if (diagnostic.actions)
        for (let action of diagnostic.actions) {
            let button = dom.appendChild(document.createElement("button"));
            button.className = (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_0__.themeClass)("diagnosticAction");
...
class DiagnosticWidget extends _codemirror_next_view__WEBPACK_IMPORTED_MODULE_0__.WidgetType {
    ...
    toDOM() {
        ...
        elt.className = (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_0__.themeClass)("lintPoint." + this.diagnostic.severity);
        return elt;
    }
}
class PanelItem {
...
const bracketMatchingState = _codemirror_next_state__WEBPACK_IMPORTED_MODULE_0__.StateField.define({
    ...
    provide: [_codemirror_next_view__WEBPACK_IMPORTED_MODULE_2__.EditorView.decorations]
});
...
function getPos(view, event) {
    ...
    let col = off > MaxOff ? -1
        : off == line.length ? absoluteColumn(view, event.clientX)
            : (0,_codemirror_next_text__WEBPACK_IMPORTED_MODULE_2__.countColumn)(line.slice(0, offset - line.from), 0, view.state.tabSize);
...
function buildPanel(conf) {
    ...
    function button(name, onclick, content) {
        return elt("button", { class: (0,_codemirror_next_view__WEBPACK_IMPORTED_MODULE_0__.themeClass)("button"), name, onclick }, content);
    }
...
const searchExtensions = [
    searchState,
    (0,_codemirror_next_state__WEBPACK_IMPORTED_MODULE_1__.precedence)(searchHighlighter, "override"),
        ...
        for (let i = 0; i < json.length; i++) {
            ...
            if (typeof part == "number") {
                ...
                while (inserted.length < i)
                    inserted.push(_codemirror_next_text__WEBPACK_IMPORTED_MODULE_0__.Text.empty);
                inserted[i] = _codemirror_next_text__WEBPACK_IMPORTED_MODULE_0__.Text.of(part[1]);
...
/* harmony export */   "nextClusterBreak": () => (/* binding */ nextClusterBreak),
/* harmony export */   "prevClusterBreak": () => (/* binding */ prevClusterBreak)
/* harmony export */ });
...
class EditorView {
    ...
    static baseTheme(spec) {
        return (0,_codemirror_next_state__WEBPACK_IMPORTED_MODULE_0__.precedence)(styleModule.of(buildTheme("." + baseThemeID, spec)), "fallback");
    }
}
...
const keymaps = _codemirror_next_state__WEBPACK_IMPORTED_MODULE_0__.Facet.define();
...
const hideNativeSelection = (0,_codemirror_next_state__WEBPACK_IMPORTED_MODULE_0__.precedence)(EditorView.theme(themeSpec), "override");
...
/***/ "./node_modules/@underlay/tasl-lezer/grammar/tasl.js":
/*!***********************************************************!*\
  !*** ./node_modules/@underlay/tasl-lezer/grammar/tasl.js ***!
  \***********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
const parser = lezer__WEBPACK_IMPORTED_MODULE_0__.Parser.deserialize({
  ...
  maxTerm: 49,
  nodeProps: [
    [lezer__WEBPACK_IMPORTED_MODULE_0__.NodeProp.group, -7,10,11,12,14,15,16,18,"Expression"]
  ],
  skippedNodes: [0,1],
  repeatNodeCount: 3,
...
/***/ "./node_modules/@underlay/tasl-lezer/lib/index.js":
/*!********************************************************!*\
  !*** ./node_modules/@underlay/tasl-lezer/lib/index.js ***!
  \********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _parse_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parse.js */ "./node_modules/@underlay/tasl-lezer/lib/parse.js");
/* harmony import */ var _stdlib_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./stdlib.js */ "./node_modules/@underlay/tasl-lezer/lib/stdlib.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils.js */ "./node_modules/@underlay/tasl-lezer/lib/utils.js");
...
/***/ "./node_modules/@underlay/tasl-lezer/lib/parse.js":
/*!********************************************************!*\
  !*** ./node_modules/@underlay/tasl-lezer/lib/parse.js ***!
  \********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _grammar_tasl_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../grammar/tasl.js */ "./node_modules/@underlay/tasl-lezer/grammar/tasl.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils.js */ "./node_modules/@underlay/tasl-lezer/lib/utils.js");
/* harmony import */ var _stdlib_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./stdlib.js */ "./node_modules/@underlay/tasl-lezer/lib/stdlib.js");
...
function parse(input) {
    const tree = _grammar_tasl_js__WEBPACK_IMPORTED_MODULE_2__.parser.configure({ strict: true }).parse(input);
    ...
    const error = (node, message) => new _utils_js__WEBPACK_IMPORTED_MODULE_3__.LintError(node.from, node.to, slice(node), message);
    const state = {
        slice,
        error,
        namespaces: {},
        types: { ..._stdlib_js__WEBPACK_IMPORTED_MODULE_4__.defaultTypes },
        schema: {},
        references: [],
    };
    do {
        if (cursor.type.name === "Namespace") {
            ...
            if (!_utils_js__WEBPACK_IMPORTED_MODULE_3__.uriPattern.test(namespace)) {
                throw state.error(term, `Invalid URI: URIs must match ${_utils_js__WEBPACK_IMPORTED_MODULE_3__.uriPattern.source}`);
            }
            ...
            const term = (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.parseURI)(state, node);
            ...
            const names = terms.map((uri) => (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.parseURI)(state, uri));
            const expression = cursor.node.getChild("Expression");
            ...
            if (label in state.schema) {
                ...
                const components = {
                    [_underlay_namespaces__WEBPACK_IMPORTED_MODULE_1__.ul.source]: _underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Schema.reference(source),
                    [_underlay_namespaces__WEBPACK_IMPORTED_MODULE_1__.ul.target]: _underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Schema.reference(target),
                };
                if (value !== null) {
            ...
            if (term in state.schema) {
                ...
                const expression = cursor.node.getChild("Expression");
                state.schema[term] = _underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Schema.coproduct({
                    [_underlay_namespaces__WEBPACK_IMPORTED_MODULE_1__.ul.none]: _underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Schema.product({}),
                    [_underlay_namespaces__WEBPACK_IMPORTED_MODULE_1__.ul.some]: _underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Schema.product({
                        [_underlay_namespaces__WEBPACK_IMPORTED_MODULE_1__.ul.head]: parseType(state, expression),
                        [_underlay_namespaces__WEBPACK_IMPORTED_MODULE_1__.ul.tail]: _underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Schema.reference(term),
                    }),
                });
            }
        }
    ...
    for (const { from, to, key } of state.references) {
        if (key in state.schema) {
            ...
            throw new _utils_js__WEBPACK_IMPORTED_MODULE_3__.LintError(from, to, key, message);
        }
    }
    return { schema: _underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Schema.schema(state.schema), namespaces: state.namespaces };
}
...
function parseType(state, node) {
    if (node.name === "Variable") {
        ...
        const type = parseType(state, expression);
        return _underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Schema.coproduct({ [_underlay_namespaces__WEBPACK_IMPORTED_MODULE_1__.ul.none]: _underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Schema.product({}), [_underlay_namespaces__WEBPACK_IMPORTED_MODULE_1__.ul.some]: type });
    }
    else if (node.name === "Reference") {
        const term = node.getChild("Term");
        const key = (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.parseURI)(state, term);
        if (!(key in state.schema)) {
            const { from, to } = term;
        ...
        const term = node.getChild("Term");
        const datatype = (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.parseURI)(state, term);
        ...
        for (const option of node.getChildren("Option")) {
            ...
            if (key in options) {
                ...
                if (expression === null) {
                    options[key] = _underlay_apg__WEBPACK_IMPORTED_MODULE_0__.Schema.product({});
                }
                else {
...
/***/ "./node_modules/@underlay/tasl-lezer/lib/stdlib.js":
/*!*********************************************************!*\
  !*** ./node_modules/@underlay/tasl-lezer/lib/stdlib.js ***!
  \*********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@underlay/tasl-lezer/lib/utils.js":
/*!********************************************************!*\
  !*** ./node_modules/@underlay/tasl-lezer/lib/utils.js ***!
  \********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
function printSyntax(node, prefix = "") {
...
var linter = (0,_lib_index_js__WEBPACK_IMPORTED_MODULE_3__.makeLinter)();
var extensions = [].concat(_toConsumableArray(_lib_index_js__WEBPACK_IMPORTED_MODULE_3__.editableConfig), [linter]);
